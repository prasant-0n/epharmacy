  ...
  return (
    <footer className="bg-gradient-to-r from-gray-100 via-[#bce1ff] to-gray-100">
      <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
            ...
            <div className="flex mt-8 space-x-6 text-gray-600">
              ...
              <a className="hover:opacity-75" href="#" target="_blank" rel="noreferrer">
                ...
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path
                    fillRule="evenodd"
                    d="M12 2C6.477 2 2 6.477 2 12c0 4.418 2.867 8.166 6.839 9.489.5.09.682-.217.682-.482 0-.237-.009-.868-.014-1.703-2.782.604-3.369-1.34-3.369-1.34-.454-1.155-1.11-1.463-1.11-1.463-.909-.621.069-.609.069-.609 1.004.07 1.532 1.032 1.532 1.032.892 1.53 2.341 1.088 2.91.832.091-.647.349-1.088.636-1.338-2.22-.252-4.555-1.11-4.555-4.943 0-1.091.39-1.984 1.03-2.683-.103-.253-.447-1.27.098-2.646 0 0 .84-.269 2.75 1.025A9.562 9.562 0 0112 6.844a9.54 9.54 0 012.508.338c1.91-1.294 2.75-1.025 2.75-1.025.545 1.376.201 2.393.099 2.646.64.7 1.03 1.592 1.03 2.683 0 3.841-2.338 4.687-4.565 4.935.358.31.678.92.678 1.854 0 1.338-.012 2.419-.012 2.75 0 .268.18.577.688.48C19.135 20.162 22 16.418 22 12c0-5.523-4.477-10-10-10z"
                    clipRule="evenodd"
                  />
                </svg>
              </a>
        ...
        <p className="mt-8 text-xs text-gray-800">© 2024. Company Name. All rights reserved.</p>
      </div>
    </footer>
  )
}
